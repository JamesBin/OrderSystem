...
import com.weixin.sdk.kit.IpKit;
...
public class WeixinPayController extends Controller {
	...
	private static String partner = PropKit.get("appId");
	private static String paternerKey = "test";
	private static String notify_url = "http://zwbscau.picp.net/OrderSystem/store";
	
	public void index() {
		// openId，采用 网页授权获取 access_token API：SnsAccessTokenApi获取
		String openId = "ojrcJuNbcjZS9xPJEngSEslN3RJc";
