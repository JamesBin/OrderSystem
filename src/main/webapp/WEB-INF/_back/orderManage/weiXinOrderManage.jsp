...
<body>
<!-- content start -->
<form class="am-form" id="listForm" action="${ctx}/back/weiXinOrderManage" method="post">
    <div class="admin-content">

        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">微信订单管理</strong> /
                <small>order</small>
            </div>
        </div>
        ...
        <div class="am-g">
            ...
            <div class="am-u-sm-12 am-u-md-3" style="padding-left: 50px;">
                ...
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <c:forEach items="${pageList.list}" var="order" varStatus="items">
                        <tr>
                            ...
                            <td><a href="${ctx}/back/weiXinOrderManageDetail?orderId=${order.orderId}" title="订单详情">${order.orderNo}</a></td>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary edit" data-am-modal="{target: '#edit-modal'}" data-id="${order.orderId}">
                                            <span class="am-icon-pencil-square-o"></span> 编辑
                                        </button>
                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only del doc-confirm-toggle del" data-id="${order.orderId}">
