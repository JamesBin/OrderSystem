...
<form class="am-form" id="listForm" action="${ctx}/back/orderManage" method="post">
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">第三方订单管理</strong> /
                <small>order</small>
            </div>
        </div>
        ...
        <div class="am-g">
            <div class="am-u-sm-12 am-u-md-3">
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <button type="button" class="am-btn am-btn-default"><span class="am-icon-archive"></span> 导入订单
                        </button>
            ...
            <div class="am-form-group am-fr">
                <select data-am-selected="{btnSize: 'sm'}">
                    <option value="option1">订单来源</option>
                    <option value="option2">微信平台</option>
                    <option value="option3">美团网</option>
                    <option value="option3">百度糯米</option>
                    <option value="option3">饿了么</option>
                </select>
            </div>
        </div>--%>
                    ...
                    <c:forEach items="${pageList.list}" var="order" varStatus="items">
                        <tr>
                            ...
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button class="am-btn am-btn-default am-btn-xs am-text-secondary edit" data-am-modal="{target: '#edit-modal'}" data-id="${order.id}"><span
                                                class="am-icon-pencil-square-o"></span> 编辑
                                        </button>
                                        <button class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only del doc-confirm-toggle del"
                                                data-id="${order.id}"><span class="am-icon-trash-o"></span> 删除
                                        </button>
                                    </div>
                                </div>
                            </td>
