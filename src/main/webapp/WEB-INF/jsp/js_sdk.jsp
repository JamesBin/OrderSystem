...
<%@page import="com.weixin.sdk.api.ApiConfigKit"%>
<%@page import="com.weixin.sdk.api.ApiConfig"%>
<%@page import="com.jfinal.kit.HashKit"%>
<%@page import="java.util.Map.Entry"%>
<%@page import="java.util.Map"%>
<%@page import="java.util.UUID"%>
<%@page import="java.util.TreeMap"%>
<%@page import="com.weixin.sdk.api.JsTicket"%>
<%@page import="com.weixin.sdk.api.JsTicketApi.JsApiType"%>
<%@page import="com.weixin.sdk.api.JsTicketApi"%>
